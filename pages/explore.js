...
import { TextField, InputAdornment, Typography, Box, Container, Grid, Button, useTheme } from '@mui/material';
    ...
    <Box sx={{ minHeight: '100vh', background: muiTheme.palette.background.default }}>
      ...
      >
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ textAlign: 'center', padding: { xs: '4rem 0', md: '4rem 0' }, color: 'white' }}>
            <Typography variant="h2" sx={{ fontFamily: themeConfig.typography.fontFamily.primary, fontWeight: 800, marginBottom: '1rem', fontSize: { xs: '2rem', md: '3rem' } }}>
            ...
            <Typography variant="h6" sx={{ marginBottom: '3rem', color: 'rgba(255, 255, 255, 0.9)', fontWeight: 400 }}>
      ...
      <Box sx={{ py: 6, background: muiTheme.palette.background.default }}>
        <Container maxWidth="xl">
          <Typography variant="h5" sx={{ marginBottom: '2rem', color: muiTheme.palette.text.primary, fontWeight: 500 }}>
          ...
          {filteredDestinations.length === 0 && (
            <Box sx={{ textAlign: 'center', padding: '4rem 2rem', backgroundColor: muiTheme.palette.background.paper, borderRadius: '20px' }}>
              <SearchIcon sx={{ fontSize: 80, color: muiTheme.palette.text.secondary, marginBottom: '1rem' }} />
              <Typography variant="h5" sx={{ marginBottom: '1rem', color: muiTheme.palette.text.primary }}>
                No destinations found
              </Typography>
              <Typography variant="body1" sx={{ color: muiTheme.palette.text.secondary, marginBottom: '2rem' }}>
