...
export default function Itinerary() {
  ...
  const displayItems = packageData.includedItems.map((item, index) => {
    if (index === 0 && customizedData?.hotel) {
      return {
        ...
        // Keep original icon and color from the item
      };
    }
  ...
  const calculateTotalBudget = () => {
    ...
    if (customizedData?.hotel) {
      ...
      // Extract hotel price from default description
    ...
    if (customizedData?.restaurant) {
      ...
      // Extract restaurant price from default description
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        {/* Two Column Layout: Included Items (Left) + Trip Itinerary (Right) */}
        <Box
          sx={{
            display: "grid",
        ...
        >
          ...
          >
              <CardContent sx={{ padding: "28px !important", flex: 1, display: "flex", flexDirection: "column" }}>
                ...
                {customizedData ? (
                  // Show total with status when customized
                  <Box
                    sx={{
                      marginTop: "24px",
                      padding: "20px",
                  ...
                  // Show only total amount when no customization
                  <Box
                    sx={{
                      marginTop: "24px",
                      padding: "20px",
